...
// Sostituisci il blocco BookingSchema.pre con questo:
BookingSchema.pre('save', async function (this: IBooking) {
  // Con 'async', non serve 'next'. Se vuoi bloccare il salvataggio, usa 'throw'.
  ...
  if (this.isModified('eventId') || this.isNew) {
    try {
      ...
      if (!eventExists) {
        // Lanciando l'errore, Mongoose interrompe il salvataggio
